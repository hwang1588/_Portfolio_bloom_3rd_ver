...
const swiper = new Swiper(".mySwiper1", {
	...
	on: {
		slideChangeTransitionStart: function () {
			...
			$(".slide1_img1, .slide1_img2, .slide1_img3").addClass('d-none').removeClass('animate__animated animate__bounceIn');
			...
			$(".slide2_img, .slide2_text, .slide3_text, .slide4_text, .gsap_text2, .gsap_text2_2, .gsap_text2_3, .gsap_text3, .gsap_text3_2, .gsap_text3_3, .gsap_text4").addClass('d-none');
		...
		slideChangeTransitionEnd: function () {
			...
			// $(".gsap_text2_2").addClass('animate__animated typewriter2').removeClass('d-none');
